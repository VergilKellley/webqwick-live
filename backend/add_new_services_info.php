...
if(isset($_POST['submit_new_service_info'])){
    ...
    $service_time = mysqli_real_escape_string($conn, $_POST['service_time']);
        ...
        $sql = "INSERT INTO services_chosen (service_title, services_description, service_price, service_time) VALUES ('$service_title', '$services_description', '$service_price', '$service_time')";
