                        ...
                        <div>
                            <form style="padding: 10px; text-align: center;" action="update_stylist_info_logic.php"
                                ...
                                <div
                                    ...
                                    <input style="margin-bottom:1rem" type="email" name="stylist_email"
                                        id="stylist_email" value="<?= $stylist_info['stylist_email'] ?>" />

                                    <label for="stylist_hours_textarea">Notes</label>
                                    <textarea style='margin-bottom: 20px; width: 97.5%; resize:none' name="stylist_hours_textarea" id="stylist_hours_textarea" cols="30"
