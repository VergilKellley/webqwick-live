...
<body>
    <div class='container' id='desk-top-calendar'>       
        <div class='left'>
        <a style="color:#fff; display:inline-block; margin-bottom: 10px" href="index.php">Back</a>
        <br>
        ...
        <div class='right'>
            ...
            <form style='display:flex; flex-direction: column; position:relative' id='calendar-form'
                ...
                <div id="select-date-modal" class='select-service-err' style='background-color: red; color: #fff; font-size: 1.2rem; position:absolute;top: 50%; left:50%; transform:translate(-50%, -50%); height: 50px; width: 100%
                ; text-align:center; font-size:25px; padding-top: 12px;  border-radius: 50px; font-size: 2'>Select a Service <button id="" style="position:absolute; right: 20px; height: 40px; width: 40px; font-size: 30px; background-color: red; border-radius: 50%; top: -20px; cursor:pointer; color:#fff; border:none" onclick="closeSelectDateModal()">x</button></div>
                ...
                <?php
                        ...
                        ?>
                <div  style='background-color: var(--prmary-clr); color: #fff; height: 150px; padding: 10px; overflow-y:scroll; border: 2px solid #fff'>
                    ...
                    <?php
                        ...
                        {
                            echo '<div id="success-modal" style="position:absolute; top: 50%; left:50%; transform:translate(-50%, -50%); width: 100%; height: 50px; padding:20px; z-index: 2; border: 1px solid green; background-color: green; border-radius:50px; display: flex; align-items: center; justify-content:center; font-size: 25px">
                            
                            <button style="position:absolute; top:-15px; right:10px; color:#fff; cursor:pointer; height: 40px; width:40px; background-color: green; border-radius: 50%; border:none; font-size: 25px;"  onclick="closeSuccessModal()">x</button>
                            
                            <h3 id="success-modal-text" style="color:#fff; text-align:center; font-size:20px">' . $_SESSION['status'] . '<h3>
                            </div>';
                ...
                <div class='today-date'>
                    <p style='margin-top: 20px' id='select-a-date-desk-top' class='medium-font'>2. Select Date</p>
                ...
                <div id='display-form-contents-div' style='margin-top:170px;'>
                    ...
                    <div style='display:flex; flex-direction:column; margin-top: 20px'>
                        <label style='margin-bottom: 10px' for='messages'>Notes to technician (optional)</label>
